  ...
  function clickHandler(e) {
    ...
    if (bdayString !== '') {
      ...
      if (!isPalindrome) {
        ...
        if (ctr1 > ctr2) {
           var ctr = ctr2>1? " days ":" day ";
          resultDiv.innerText = `The nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} ${ctr}.`;
        } else {
            var ctr = ctr1>1?" days ":" day ";
          resultDiv.innerText = `The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} ${ctr}.`;
        }
